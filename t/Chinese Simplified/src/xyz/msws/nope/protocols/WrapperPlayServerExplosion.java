...
public class WrapperPlayServerExplosion extends AbstractPacket {
   ...
   */
  public void setX(double value) { handle.getDoubles().write(0, value); }
   ...
   * @param value - new value.
   */
  public void setY(double value) { handle.getDoubles().write(1, value); }
   ...
   * @param value - new value.
   */
  public void setZ(double value) { handle.getDoubles().write(2, value); }
   ...
   */
  public float getRadius() { return handle.getFloat().read(0); }
   ...
   * @param value - new value.
   */
  public void setRadius(float value) { handle.getFloat().write(0, value); }
  ...
  public float getPlayerVelocityX() { return handle.getFloat().read(1); }

  public void setPlayerVelocityX(float value) {
    handle.getFloat().write(1, value);
  }

  public float getPlayerVelocityY() { return handle.getFloat().read(2); }

  public void setPlayerVelocityY(float value) {
    handle.getFloat().write(2, value);
  }

  public float getPlayerVelocityZ() { return handle.getFloat().read(3); }
