...
public abstract class AbstractCommand
    extends AbstractModule implements CommandExecutor, TabCompleter {

  protected List<Subcommand> cmds = new ArrayList<>();

  public AbstractCommand(NOPE plugin) { super(plugin); }
  ...
  public List<Subcommand> getSubCommands() { return cmds; }
