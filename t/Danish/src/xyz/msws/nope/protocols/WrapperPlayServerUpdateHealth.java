...
public class WrapperPlayServerUpdateHealth extends AbstractPacket {
   ...
   */
  public float getHealth() { return handle.getFloat().read(0); }
   ...
   */
  public void setHealth(float value) { handle.getFloat().write(0, value); }
   ...
   */
  public int getFood() { return handle.getIntegers().read(0); }
   ...
   * @param value - new value.
   */
  public void setFood(int value) { handle.getIntegers().write(0, value); }
   ...
   */
  public float getFoodSaturation() { return handle.getFloat().read(1); }
