...
public class WrapperPlayClientUseEntity extends AbstractPacket {
   ...
   */
  public int getTargetID() { return handle.getIntegers().read(0); }
   ...
   */
  public void setTargetID(int value) { handle.getIntegers().write(0, value); }
   ...
   */
  public Vector getTargetVector() { return handle.getVectors().read(0); }
