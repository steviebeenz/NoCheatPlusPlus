...
public class WrapperPlayServerEntityEffect extends AbstractPacket {
   ...
   */
  public byte getEffectID() { return handle.getBytes().read(0); }
   ...
   */
  public byte getAmplifier() { return handle.getBytes().read(1); }
   ...
   */
  public int getDuration() { return handle.getIntegers().read(1); }
   ...
   * @param value - new value.
   */
  public void setDuration(int value) { handle.getIntegers().write(1, value); }
   ...
   */
  public boolean getHideParticles() { return handle.getBytes().read(2) == 0; }
