...
public class WrapperPlayClientSettings extends AbstractPacket {
   ...
   */
  public String getLocale() { return handle.getStrings().read(0); }
   ...
   */
  public void setLocale(String value) { handle.getStrings().write(0, value); }
   ...
   */
  public int getViewDistance() { return handle.getIntegers().read(0); }
   ...
   */
  public boolean getChatColours() { return handle.getBooleans().read(0); }
   ...
   */
  public int getDisplayedSkinParts() { return handle.getIntegers().read(1); }
