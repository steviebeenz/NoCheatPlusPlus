...
public class WrapperPlayServerNamedEntitySpawn extends AbstractPacket {
   ...
   */
  public UUID getPlayerUUID() { return handle.getUUIDs().read(0); }
   ...
   * @param value - new value.
   */
  public void setPlayerUUID(UUID value) { handle.getUUIDs().write(0, value); }
   ...
   */
  public float getYaw() { return (handle.getBytes().read(0) * 360.F) / 256.0F; }
