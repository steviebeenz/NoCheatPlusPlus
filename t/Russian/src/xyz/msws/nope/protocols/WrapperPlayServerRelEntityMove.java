...
public class WrapperPlayServerRelEntityMove extends AbstractPacket {
   ...
   */
  public double getDx() { return handle.getShorts().read(0) / 4096D; }
   ...
   */
  public double getDy() { return handle.getShorts().read(1) / 4096D; }
   ...
   */
  public double getDz() { return handle.getShorts().read(2) / 4096D; }
